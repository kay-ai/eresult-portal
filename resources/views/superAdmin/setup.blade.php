@extends('layouts.app', [($activePage = 'Basic Info')])
    ...
    <div class="me-2">
        <div class="row mt-4">
            <form method="post" id="schlDetailsForm" action="" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$account->id ?? null}}">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card p-3 shadow-sm">
                            <p class="text-kdis-2 mb-3 subheader">School Logo/Badge</p>
                    ...
                    <div class="col-md-8">
                        <div class="card p-3 shadow-sm">
                            <p class="text-kdis-2 mb-3 subheader">School Account Details</p>
                            ...
                            <div class="row text-center p-2">
                                <button type="submit" id="saveSetUpBtn" class="btn btn-first">Save
                                    Changes</button>
                            </div>
                        </div>
                    </div>
